  ...
  return (
    <>
      ...
      <div className="mt-4 text-secondary text-[17px] max-w-3xl leading-[30px]">
        ...
        development and a keen interest in exploring new technologies. I am
        constantly seeking opportunities to enhance my skills and contribute to
        innovative projects. With a solid foundation in programming and
        problem-solving, I am eager to take on challenges that allow me to grow
        as a developer and make a meaningful impact in the tech industry. i am
        currently learning frontend and backend technologies, and I am excited
        to apply my knowledge to real-world projects. I am a quick learner,
        adaptable, and always ready to embrace new challenges in the
